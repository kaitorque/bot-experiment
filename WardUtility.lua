...
local RADIANT_T2MIDFALL = Vector(-516.000000, -3324.000000, 0.000000);
local RADIANT_T2BOTFALL = Vector(1280.000000, -5120.000000, 0.000000);

local RADIANT_T1TOPFALL = Vector(-4096.000000, 1536.000000, 0.000000);
local RADIANT_T1MIDFALL = Vector(128.000000, -2688.000000, 0.000000);
local RADIANT_T1BOTFALL = Vector(3958.000000, -3904.000000, 0.000000);

local RADIANT_MANDATE1 = Vector(-1571.000000, 215.000000, 0.000000);
local RADIANT_MANDATE2 = Vector(2816.000000, -3072.000000, 0.000000);
...
local RADIANT_AGGRESSIVEBOT  = Vector(4608.000000, 768.000000, 0.000000);
...
local DIRE_T2TOPFALL = Vector(528.000000, 4080.000000, 0.000000);
local DIRE_T2MIDFALL = Vector(756.000000, 2647.000000, 0.000000);
local DIRE_T2BOTFALL = Vector(4600.000000, 768.000000, 0.000000);

local DIRE_T1TOPFALL = Vector(-4416.000000, 4608.000000, 0.000000);
local DIRE_T1MIDFALL = Vector(624.000000, -373.000000, 0.000000);
local DIRE_T1BOTFALL = Vector(3904.000000, -896.000000, 0.000000);

local DIRE_MANDATE1 = Vector(-768.000000, 2048.000000, 0.000000);
...
local DIRE_AGGRESSIVEMID2 = Vector(-516.000000, -3324.000000, 0.000000);
local DIRE_AGGRESSIVEBOT  = Vector(1280.000000, -5120.000000, 0.000000);
...
local MandatoryWardSpotRadiant = {
	RADIANT_MANDATE1,
	RADIANT_MANDATE2
}

local MandatoryWardSpotDire = {
	DIRE_MANDATE1,
	DIRE_MANDATE2
}
...
function X.GetMandatorySpot()
	...
	if GetTeam() == TEAM_RADIANT then
		return MandatoryWardSpotRadiant;
	else
		return MandatoryWardSpotDire
	end	
end
